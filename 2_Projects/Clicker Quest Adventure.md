...
(Gif où on montre l'écran qui s'adapte à la taille)
...
(Gif où on montre la quantité de scriptable objects, avec une légende qui décrit tout ça)

This project was also an opportunity to discover time management tools such as **Coroutine**, in order to set up temporal events such as the duration or cooldowns of abilities, and mob attack charges.

(Gif où on montre des événements en durée. Compétence en charge, cooldown, barre d'ennemi)
...
(Gif d'une situation de jeu où plein de choses se passent à l'écran)
